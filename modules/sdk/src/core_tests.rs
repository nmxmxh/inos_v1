...
mod ringbuffer_tests {
    ...
    fn test_ringbuffer_creation() {
        let mock_sab = SafeSAB::new(&web_sys::wasm_bindgen::JsValue::NULL);
...
mod signal_tests {
    ...
    fn test_epoch_creation() {
        let epoch = Epoch::new(&web_sys::wasm_bindgen::JsValue::NULL, 0);
        assert_eq!(epoch.current(), 0);
    }

    #[test]
    fn test_epoch_increment() {
        let mut epoch = Epoch::new(&web_sys::wasm_bindgen::JsValue::NULL, 0);
        epoch.increment();
    ...
    #[test]
    fn test_epoch_wait() {
        let _epoch = Epoch::new(&web_sys::wasm_bindgen::JsValue::NULL, 5);
        // wait() method not available in current API
    }

    #[test]
    fn test_reactor_creation() {
        let mock_sab = &web_sys::wasm_bindgen::JsValue::NULL;
