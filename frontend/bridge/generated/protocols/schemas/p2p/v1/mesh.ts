...
import { CompressParams, CompressParams_Algorithm, DelegateRequest, DelegateRequest_Operation, DelegateResponse, DelegateResponse_Status, EncryptParams, EncryptParams_Algorithm, ExecutionMetrics, HashParams, HashParams_Algorithm } from "./delegation.js";
...
export class P2PMesh_DelegateCompute$Params extends $.Struct {
  ...
  _adoptRequest(value: $.Orphan<DelegateRequest>): void {
    $.utils.adopt(value, $.utils.getPointer(0, this));
  }
  _disownRequest(): $.Orphan<DelegateRequest> {
    return $.utils.disown(this.request);
  }
  get request(): DelegateRequest {
    return $.utils.getStruct(0, DelegateRequest, this);
  }
  _hasRequest(): boolean {
    return !$.utils.isNull($.utils.getPointer(0, this));
  }
  _initRequest(): DelegateRequest {
    return $.utils.initStructAt(0, DelegateRequest, this);
  }
  set request(value: DelegateRequest) {
    $.utils.copyFrom(value, $.utils.getPointer(0, this));
  }
...
export class P2PMesh_DelegateCompute$Results extends $.Struct {
  ...
  _adoptResponse(value: $.Orphan<DelegateResponse>): void {
    $.utils.adopt(value, $.utils.getPointer(0, this));
  }
  _disownResponse(): $.Orphan<DelegateResponse> {
    return $.utils.disown(this.response);
  }
  get response(): DelegateResponse {
    return $.utils.getStruct(0, DelegateResponse, this);
  }
  _hasResponse(): boolean {
    return !$.utils.isNull($.utils.getPointer(0, this));
  }
  _initResponse(): DelegateResponse {
    return $.utils.initStructAt(0, DelegateResponse, this);
  }
  set response(value: DelegateResponse) {
    $.utils.copyFrom(value, $.utils.getPointer(0, this));
  }
