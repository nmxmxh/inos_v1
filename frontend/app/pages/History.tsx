  ...
  return (
    <Style.BlogContainer>
      ...
      >
        ...
        <Style.PageTitle>History: The 30-Year Correction</Style.PageTitle>
        <Style.LeadParagraph>
      ...
      <Style.ContentCard>
        ...
        <Style.DeepDiveGrid>
          ...
          <Style.DeepDiveLink to="/deep-dives/atomics" $color="#8b5cf6">
            ...
            <Style.DeepDiveDesc>The indivisible logic</Style.DeepDiveDesc>
          </Style.DeepDiveLink>
      ...
      <ChapterNav
        ...
        next={{ to: '/whats-next', title: "05. What's Next" }}
      />
    </Style.BlogContainer>
  );
}
