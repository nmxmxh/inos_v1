...
func (aa *AdaptiveAllocator) CalculateReplicas(r common.Resource) int {
...
func (aa *AdaptiveAllocator) CalculateStorageCost(r common.Resource, replicas int) float64 {
...
func (aa *AdaptiveAllocator) CalculateRetrievalCost(r common.Resource) float64 {
...
func (aa *AdaptiveAllocator) EstimateNetworkLoad(r common.Resource, replicas int) NetworkLoad {
